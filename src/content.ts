...
export const beats: Beat[] = [
  ...
  },
  {
    ...
    off: 'Ask friends for book and podcast recommendations. Look into volunteering options.',
  },
  {
    id: '3-months',
    kicker: 'In 3 months',
    job: 'A plan to modernise the Loyalty services, and refactoring underway. Pairing more. Team relationships deepening.',
    off: 'Reading and listening — news, politics, history. Writing my own thoughts down.',
  },
  {
    id: '6-months',
    kicker: 'In 6 months',
    job: 'Team ways of working genuinely improved. Loyalty services refactored to a solid, modern baseline.',
    off: 'Still reading, still listening. Writing has started to find a public home.',
  },
  {
    id: '1-year',
    kicker: 'In a year',
    ...
    off: "Volunteering somewhere the stakes are real — RNLI if I can, something adjacent if I can't. Publishing on the things I keep coming back to: books, history.",
    epilogue:
